...
public class TopPlayers : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        player1.text = "1st place: " + players[0].name + ", Score: " + players[0].score;
        player2.text = "2nd place: " + players[1].name + ", Score: " + players[1].score;
        player3.text = "3rd place: " + players[2].name + ", Score: " + players[2].score;
        player4.text = "4th place: " + players[3].name + ", Score: " + players[3].score;
        player5.text = "5th place: " + players[4].name + ", Score: " + players[4].score;
    }
